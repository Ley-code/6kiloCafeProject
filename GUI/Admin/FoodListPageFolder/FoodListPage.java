...
public class FoodListPage extends WelcomePage {
    ...
    private void initialize() {
        ...
        mondayPanel.breakfastImageLabel.setIcon(FoodIcon.scaledIcon("GUI/icons/Firfir.png"));
        mondayPanel.lunchimagLabel.setIcon(FoodIcon.scaledIcon("GUI/icons/aynet.png"));
        mondayPanel.dinnerImageLabel.setIcon(FoodIcon.scaledIcon("GUI/icons/cake.jpg"));
