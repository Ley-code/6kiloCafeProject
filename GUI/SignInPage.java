        ...
        passwordLabel.getFont().getStyle() | java.awt.Font.BOLD,
        passwordLabel.getFont().getSize() + 2));
        passwordLabel.setText("Password:");

        usernameLabel.setFont(usernameLabel.getFont().deriveFont(
        usernameLabel.getFont().getStyle() | java.awt.Font.BOLD,
        usernameLabel.getFont().getSize() + 2));
        ...
        .createSequentialGroup()
        .addGap(83, 83, 83)
        .addComponent(LoginTabContainer,
        javax.swing.GroupLayout.PREFERRED_SIZE,
        javax.swing.GroupLayout.DEFAULT_SIZE,
        javax.swing.GroupLayout.PREFERRED_SIZE))
        .addGroup(MiddlecontainerLayout
